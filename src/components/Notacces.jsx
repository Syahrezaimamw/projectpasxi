  ...
  return (
    <div className='flex items-center justify-center min-h-[100dvh] bg-white dark:bg-white wrapper '>
        <div className='flex flex-col items-center'>
            ...
            <Link to='/login' className='flex items-center gap-2 mt-1 text-center hover:underline group' ><FaArrowLeft className='group-hover:-translate-x-2 transition-all duration-300 text-[14px] mt-1 '/> return to the login page</Link>
        </div>
